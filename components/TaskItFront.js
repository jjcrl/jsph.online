      ...
      <div className="w-full h-screen bg-zinc-200 overflow-hidden">
        <div className="flex flex-row w-full h-fit items-center align-center justify-between">
          <div className="w-2/3 h-12 bg-indigo-50 ml-10 rounded-3xl shadow-sm">
            <div className="w-72 bg-lime-500 h-full rounded-l-3xl"></div>
          </div>
        ...
        <ul className="h-fit w-fit flex flex-row m-auto pt-5 pb-10 gap-2">
          ...
          <li className="text-7xl bg-white h-fit w-fit p-5 rounded-full -mr-8 shadow-md border-4 border-zinc-300 opacity-70 z-30">
            🧠
          </li>
          <li className="text-7xl bg-white h-fit w-fit p-5 rounded-full -mr-8 shadow-md border-4 border-zinc-300 opacity-80 z-30">
            🚀
          </li>
          <li className="text-7xl bg-white h-fit w-fit p-5 rounded-full -mr-8 shadow-md border-4 border-zinc-300 opacity-90 z-40">
            💯
          </li>
          <li className="text-7xl bg-white h-fit w-fit p-5 rounded-full shadow-md border-4 border-zinc-300 z-50">
            🎯
          </li>
        ...
        <ul className="flex flex-col gap-5 text-zinc-700 pl-5">
          <li className="w-full h-fit px-5 ">
            <div className="flex flex-row w-full h-full">
              <span className="text-5xl bg-zinc-50 p-4 rounded-2xl shadow-md border-4 border-zinc-300">
                ✅
              </span>
              <p className="text-3xl bg-indigo-50 px-10 py-5 line-through rounded-3xl shadow-sm border-4 border-zinc-300 ml-5">

    ...
    <section>
      <div className="w-full h-full bg-zinc-200 overflow-hidden">
        <div className="flex flex-row w-full h-fit items-center align-center justify-between">
          ...
          <h4 className=" p-5 text-right text-zinc-800 text-6xl font-bold">
            75%
          </h4>
        </div>
        <ul className="h-fit w-fit flex flex-row m-auto pt-5 pb-10 gap-2">
          <li className="text-6xl bg-zinc-200 w-28 h-28 grid items-center px-5  rounded-full border-4 border-zinc-200 font-semibold text-white">
            +3
          </li>
        ...
        <ul className="flex flex-col gap-5 text-zinc-700 pl-5">
          <li className="w-full h-fit px-5 ">
            <div className="flex flex-row w-full h-full">
              ...
              <p className="text-3xl bg-indigo-50 px-10 py-5 line-through rounded-3xl shadow-md border-4 border-zinc-300 ml-5 font-medium">
                🥳 Fix alignment bug on div.
              </p>
            </div>
          </li>
          <li className="w-full h-fit px-5">
